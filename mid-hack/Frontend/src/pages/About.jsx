        ...
        <div className="bg-gradient-to-b from-gray-950 to-gray-900">
            ...
            >
              ...
              <div className="mt-4 max-w-4xl mx-auto text-center text-gray-300">
                ...
                <p className="mt-4 text-2xl">
                  We believe that efficiency and sustainability should go hand in hand. Our team is dedicated to continuous improvement, always exploring new technologies and methods to help businesses ship smarter and greener. With ShipWise, you’re not just shipping products—you’re joining a movement towards a more efficient, eco-friendly future.
                </p>
              </div>
            </motion.section>
          </div>
              ...
              >
                <div className="flex-1 px-6 md:px-12 mx-4">
                  ...
                  <p className="text-xl md:text-2xl leading-relaxed text-gray-300">
                    To develop an innovative algorithm-based system that streamlines the carton packing process. By optimizing space utilization, selecting the most efficient shipping methods, and integrating user-friendly features, we empower businesses to reduce packaging waste, cut down on transportation costs, and make informed decisions on courier services, all while contributing to a greener future.
                  </p>
                </div>
          ...
          <div className="flex justify-center my-8 items-center">
            <motion.section
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-semibold text-center text-gray-200">Sustainability Matters</h2>
              <p className="mt-4 text-lg text-center text-gray-100 px-12 mx-40">
                ShipWise is dedicated to sustainable practices. Our algorithms optimize packaging to minimize waste, helping you ship responsibly and reduce your environmental impact.
              </p>
            </motion.section>
          </div>
            ...
            <div className="space-y-4 container mt-6">
              ...
              {faqData.map((faq, index) => (
                ...
                >
                  ...
                  {openIndex === index && (
                    <div className="mt-4 leading-relaxed text-gray-700 dark:text-gray-200 border p-2 rounded-lg border-green-300">
                      {faq.answer}
                    </div>
                  )}
                </div>
